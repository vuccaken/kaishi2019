...
\begin{itemize} % numberingするならenumerate環境を使いましょう
  \item[\maru{1}] $\rmA$
...
% したがって真理値の定義もくそもかつやまたはの意味からこうなるのは当然じゃないかと思うかもしれない．
したがって真理値の定義も「かつ」や「または」の意味からこうなるのは当然じゃないかと思うかもしれない．
% しかし，かつやまたはとはどういう意味だろうか，その意味を知らない人に説明できるだろうか．
しかし，「かつ」や「または」とはどういう意味だろうか，その意味を知らない人に説明できるだろうか．
% なにが言いたいのかというと，この真理値の定義によって否定詞と接続しの意味を改めて規定したということである．
...
\begin{table}[H]
  ...
  %   $\rmA$ & $\rmB$ & $\rmB \to \rmA$ &$\rmA \to (\rmB \to \rmA)$ \\ \hline \hline
  %   T & T & T & T \\ \hline
  %   T & F & T & T \\ \hline
  %   F & T & F & T \\ \hline
  %   F & F & T & T \\ \hline
...
\begin{table}[H]
  ...
  \caption{\maru{ア}}
  % \begin{tabular}{|c|c||c|c|c|}\hline
  %   $\rmA$ & $\rmB$ & $\rmA \to \rmB$ & $(\rmA \to \rmB) \land \rmA$ & $((\rmA \to \rmB) \land \rmA) \to \rmB$ \\ \hline \hline
  %   T & T & T & T & T \\ \hline
  %   T & F & F & F & T \\ \hline
  %   F & T & T & F & T \\ \hline
  %   F & F & T & F & T \\ \hline
...
\begin{table}[H]
  ...
  %   $\rmA$ & $\rmB$ & $\rmA \to \rmB$ & $\lnot \rmA$ & $(\rmA \to \rmB) \land \lnot\rmA$ & $\lnot\rmB$ & $((\rmA \to \rmB) \land \lnot\rmA) \to \lnot\rmB$ \\ \hline \hline
  %   T & T & T & F & F & F & T \\ \hline
  %   T & F & F & F & F & T & T \\ \hline
  %   F & T & T & T & T & F & F \\ \hline
  %   F & F & T & T & T & T & T \\ \hline
...
% これを判定するには$\rmA\to\rmB$の真理値表を書いてこれがトートロジーになるかを見ればよかった．
