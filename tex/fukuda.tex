...
\section{磁気単極子の存在仮定}
ここからは、前の章とは打って変わって、マクスウェル方程式を疑ってかかっていきます。先に申し上げますと、磁気単極子を仮定しますから、当然磁気単極子の存在を認めていない電磁気学の基礎方程式、マクスウェル方程式は矛盾だらけの代物となります。つまり、これは単なる思考実験、妄想の産物です。科学的根拠は皆無です。それを踏まえたうえでお読みください。
\subsection{具体例}
では、実際に具体例をいくつか考えていきます。
\subsubsection{〈例１〉}
磁気単極子が単独である状況を考えます。これは至極単純で、磁場を$\mathbf{B}$、磁荷を$q_m$
