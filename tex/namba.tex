...
\begin{figure}[ht]
  \centering
\includegraphics[width=80mm]{namba/ryuutai1.png}
\caption{円柱周りの流線}
\end{figure}
\par
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=80mm]{namba/ryuutai3.png}
  \caption{一様流の例}
\end{figure}
\par
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=80mm]{namba/ryuutai2.png}
  \caption{二重吹き出しの例}
\end{figure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=80mm]{namba/ryuutai4.png}
  \caption{翼の模式図}
\end{figure}
\subsection{流線形}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=80mm]{namba/ryuutai5.png}
  \caption{円柱の剥離}
  \centering
  \includegraphics[width=80mm]{namba/ryuutai6.png}
  \caption{流線形の物体の剥離}
\end{figure}
\subsection{反り}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=80mm]{namba/ryuutai7.png}
  \caption{翼まわりの流れ}
\end{figure}
\subsection{迎え角}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=80mm]{namba/ryuutai8.png}
  \caption{翼の特性曲線}
\end{figure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=80mm]{namba/ryuutai9.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=60mm]{namba/ryuutai10.png}
  \centering
  \includegraphics[width=60mm]{namba/ryuutai11.png}
  \centering
  \includegraphics[width=60mm]{namba/ryuutai12.png}
