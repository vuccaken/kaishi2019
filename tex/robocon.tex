...
\begin{figure}[H]
  \centering
  \includegraphics[height=5cm]{robocon/robot05.png}
  \caption{ロボットハンド}
  \label{fig:ロボットハンド}
\end{figure}
...
\begin{figure}[htbp]]
  \centering
  \includegraphics[width=12cm]{robocon/robot06.png}
...
\begin{table}[H]
  ...
  \label{tbl:各理論値}
  \begin{tabular}{|c|c|c|c|c|} \hline
    質量$M\tani*{kg}$& 角加速度$\ddot{q}$$\tani*{rad/s^2}$& 加速度$\dot{q}$$\tani*{m/s}$& 最大応力$\sigma\tani*{Pa}$& \begin{tabular}{c}慣性モーメント\\$I_z\tani*{kgm^2}$\end{tabular}\\ \hline
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=15cm]{robocon/robot21.png}
